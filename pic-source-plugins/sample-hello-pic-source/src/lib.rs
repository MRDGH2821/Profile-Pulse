...
#[unsafe(no_mangle)]
pub extern "C" fn discover(ctx_ptr: i32, ctx_len: i32, out_ptr: i32, out_cap: i32) -> i32 {
...
#[unsafe(no_mangle)]
pub extern "C" fn fetch_pic(token_ptr: i32, token_len: i32, out_ptr: i32, out_cap: i32) -> i32 {
